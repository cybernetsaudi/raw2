...
try {
    ...
    // Get materials used in the batch
    $materials_query = "SELECT mu.material_id, rm.name, rm.unit, mu.quantity_required,
                       (SELECT AVG(unit_price) FROM purchases WHERE material_id = mu.material_id) as avg_unit_price
    ...
    foreach ($materials as $material) {
        ...
        $total_cost = $material['quantity_required'] * $unit_price;
        
        $material_item = [
            'id' => $material['material_id'],
            'name' => $material['name'],
            'quantity' => floatval($material['quantity_required']),
            'unit' => $material['unit'],
